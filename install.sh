...
set -euo pipefail
APP=p-coder
REPO="titipakorn-th/p-code-releases"
...
check_version() {
    if command -v $APP >/dev/null 2>&1; then
        ...
        installed_version=$($APP --version 2>/dev/null | awk '{print $NF}' || echo "")
...
echo -e "${MUTED}█▀▀▀ ░░ █▀▀▀ ▀▀▀▀ ▀  ▀ ▀▀▀ █░░█${NC}"
echo -e ""
echo -e "${MUTED}P-Coder v$specific_version installed successfully!${NC}"
echo -e ""
echo -e "To start:"
echo -e "  p-coder"
echo -e ""
